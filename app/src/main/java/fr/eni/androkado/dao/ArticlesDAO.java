...
public class ArticlesDAO {
    ...
    public ArticlesDAO(Context context) {
        helper = new GestionArticlesHelper(context);
    }
    ...
    public void update(Article article)
    {
        ...
        // Passer la requete
        int nbLignesModifies = db.update(GestionArticlesContract.Articles.TABLE_NAME, valeurs, whereClause, whereParams);

        Log.d(TAG, "nbLignesModifiés = " + nbLignesModifies);
    ...
    public void delete(Article article)
    {
        ...
        // Passer la requete
        int nbLignesModifies = db.delete(GestionArticlesContract.Articles.TABLE_NAME, whereClause, whereParams);
